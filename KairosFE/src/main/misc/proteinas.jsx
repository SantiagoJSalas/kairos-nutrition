...
function Proteinas() {
    return (
        <div className="bg-kairosblack space-y-10 h-screen py-20 flex flex-col items-center relative">
            <h1 className="text-center text-kairoswhite text-6xl font-bold">PROTEINAS</h1>
            ...
            <div className="w-[85%] h-10 bg-kairosgold absolute bottom-0 left-0 rounded-tr-xl z-10"></div>
        </div>
    )
}
